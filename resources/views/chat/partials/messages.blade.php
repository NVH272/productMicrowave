...
<div class="d-flex mb-3 {{ $msg->sender_id == auth()->id() ? 'justify-content-end' : 'justify-content-start' }}">
    ...
    <!-- {{-- Nếu là mình thì avatar nằm bên phải --}}
    @if($msg->sender_id == auth()->id())
    <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=0084FF&color=fff"
        class="rounded-circle ms-2" width="32" height="32" alt="avatar">
    @endif -->
</div>
@empty
